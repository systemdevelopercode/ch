...
<head>
    ...
    <link rel="stylesheet" href="bower_components/fontawesome4/css/font-awesome.min.css">
...
<header class="row">
    ...
    <section class="col-sm-3">
        ...
        <span class="glyphicon glyphicon-envelope">Email :admin@continentalhorizons.org</span><br>
        <span class="glyphicon glyphicon-earphone"><a href="https://wa.me/+263778816135">Whatsapp :+263 778 816 135</a></span><br>
        <span class="fa fa"><a href="tel:+263 54 22 31011"> Call :+263 54 22 31011</a></span><br>
    </section>
    <section class="col-sm-3">
        <span class="">Follow Us</span><br>
        <span class="fa fa-facebook" style="color:blue;"><a href="https://www.facebook.com/">Facebook</a></span><br>
        <span class="fa fa-twitter" style="color:blue;"><a href="https://www.twitter.com/">Twitter</a></span><br>
        <span class="fa fa-instagram" style="color:blue;"><a href="https://www.instagram.com/">Instagram</a></span><br>
        <span class="fa fa-linkedin" style="color:blue;"><a href="https://www.linkedin.com/">LinkedIn</a></span><br>
    </section>
</header>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
                ...
                <li class="nav-item mx-3">
                    <a class="nav-link btn btn-info" href="index.php">Training</a>
                </li>
                <li class="nav-item">
